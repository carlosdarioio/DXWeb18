...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
  ...
  <div class="carousel-inner">  
      ...
      <div class="carousel-item active">
        <img src="Images/portadaMesferretero2.png" class="d-block w-100" />
    </div>  

    <div class="carousel-item">
        <img src="Images/portadaMesferretero.png" class="d-block w-100" />
    </div>  

    <div class="carousel-item">
      <img src="Images/portadafestivalsuperheroes.png" alt="Second slide" class="d-block w-100"/>
    </div>



    <div class="carousel-item ">
      <img src="Images/Portadilla%20Carrusel2.png" alt="Second slide" class="d-block w-100"/>
    </div>
		...
		<div style='display:none'>
			  <div id='inline_content' style='padding:10px; background:#fff;'>
			      <div id="cal22" runat ="server"> 
                      <img src="Images/img42.png" width="100%" height="100%"/>            
			      </div> 
