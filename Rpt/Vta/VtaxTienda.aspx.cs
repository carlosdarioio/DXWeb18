...
{
    public partial class VtaxTienda : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                try
                {
                    string sql = "EXEC   [AS400Sync].[dbo].[CFVentaDeTiendaxRado]		@Sucursal = N'{0}',		@Desde = '{1}',		@Hasta = '{2}'";
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            ASPxPivotGridExporter1.ExportXlsToResponse("VtaXRado.xls", new XlsExportOptionsEx() { ExportType = ExportType.WYSIWYG });
            //---------------------------------
