<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTest1.Master" AutoEventWireup="true" CodeBehind="VtaxTiendxTpDescDado.aspx.cs" Inherits="DXWeb18.Rpt.Vta.VtaxTiendxTpDescDado" %>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Descuento x tienda</h3>
                  ...
                  <div class="form-group">    
                      ...
                      <dx:ASPxPivotGrid ID="PivotGridViewXX"  ClientInstanceName="PivotGridViewXX"  runat="server"
                          ...
                          <Fields>
                              ...
                              <dx:PivotGridField ID="fieldTPDesc" AreaIndex="0" FieldName="TPDesc" Name="fieldTPDesc" Options-ShowInFilter="True">
                              </dx:PivotGridField>
                              <dx:PivotGridField ID="fieldCantidad"  AreaIndex="1" FieldName="Cantidad" Name="fieldCantidad" Options-ShowInFilter="True">
                              </dx:PivotGridField>
                              ...
                              <dx:PivotGridField ID="fieldSucursal" Area="RowArea" AreaIndex="0" FieldName="Sucursal" Name="fieldSucursal" Options-ShowInFilter="True">
                              </dx:PivotGridField>  

                              <dx:PivotGridField ID="fieldVendedor" Area="RowArea" AreaIndex="1" FieldName="Vendedor" Name="fieldVendedor" Options-ShowInFilter="True">
                              </dx:PivotGridField>  

                              <dx:PivotGridField ID="fieldFactura" Area="RowArea" AreaIndex="2" FieldName="Factura" Name="fieldFactura" Options-ShowInFilter="True">
                              </dx:PivotGridField>  

                              <dx:PivotGridField ID="fieldCliente" Area="RowArea" AreaIndex="3" FieldName="Cliente" Name="fieldCliente" Options-ShowInFilter="True">
                              </dx:PivotGridField>  

                              <dx:PivotGridField ID="fieldArticulo" Area="RowArea" AreaIndex="4" FieldName="Articulo" Name="fieldArticulo" Options-ShowInFilter="True">
                              </dx:PivotGridField>  
                              ...
                              <dx:PivotGridField ID="fieldPrecioNormal" Area="DataArea" AreaIndex="0" FieldName="PrecioNormal" Name="fieldPrecioNormal" Options-ShowInFilter="True">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldDescuento" Area="DataArea" AreaIndex="1" FieldName="Descuento" Name="fieldDescuento" Options-ShowInFilter="True">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldPrecio" Area="DataArea" AreaIndex="2" FieldName="Precio" Name="fieldPrecio" Options-ShowInFilter="True">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldVenta" Area="DataArea" AreaIndex="3" FieldName="Venta" Name="fieldVenta" Options-ShowInFilter="True">
                              </dx:PivotGridField>
