...
{
    public partial class TckProm : System.Web.UI.Page
    {
        ...
        ", user));
            ...
            if (IsPostBack)
            {
                try
                {
                    string sql = "EXEC	[AS400Sync].[dbo].[RPTTicketPromedio] @Tipo = N'{0}', @FromDate = '{1}', @ToDate = '{2}'";
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            ASPxPivotGridExporter1.ExportXlsToResponse("TckProm.xls", new XlsExportOptionsEx() { ExportType = ExportType.WYSIWYG });
            //---------------------------------
