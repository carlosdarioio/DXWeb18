<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTest1.Master" AutoEventWireup="true" CodeBehind="VtaXRentaXVndor.aspx.cs" Inherits="DXWeb18.Rpt.Vta.VtaXRentaXVndor" %>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Renta x Vendedor</h3>
                  ...
                  <div class="form-group">    
                      ...
                      <dx:ASPxPivotGrid ID="PivotGridViewXX"  ClientInstanceName="PivotGridViewXX"  runat="server"
                          ...
                          <Fields>
                              ...
                              <dx:PivotGridField ID="fieldTipoAlmacen"  AreaIndex="2" FieldName="TipoAlmacen" Name="fieldTipoAlmacen" Options-ShowInFilter="True">
                              </dx:PivotGridField>                             
                              ...
                              <dx:PivotGridField ID="fieldVenta" Area="DataArea" AreaIndex="1" FieldName="Venta" Name="fieldVenta" Options-ShowInFilter="True">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldCosto" Area="DataArea" AreaIndex="2" FieldName="Costo" Name="fieldCosto" Options-ShowInFilter="True">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldMargen" Area="DataArea" CellFormat-FormatString="%" AreaIndex="3" FieldName="Margen" Name="fieldMargen" Options-ShowInFilter="True">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldx" Area="DataArea" AreaIndex="4" FieldName="x" Name="fieldx" Options-ShowInFilter="True">
                              </dx:PivotGridField> 
