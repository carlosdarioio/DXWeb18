<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTest1.Master" AutoEventWireup="true" CodeBehind="VtaXCartDeVendedor.aspx.cs" Inherits="DXWeb18.Rpt.Vta.VtaXCartDeVendedor" %>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Venta x Cartera De Vendedor</h3>
                      ...
                      <dx:ASPxPivotGrid ID="PivotGridViewXX"  ClientInstanceName="PivotGridViewXX"  runat="server"
                          ...
                          <Fields>
                              ...
                              <dx:PivotGridField ID="fieldRado" AreaIndex="3" FieldName="Rado" Name="fieldRado" Options-ShowInFilter="True">
                               ...
                               <dx:PivotGridField ID="fieldVendedorFinal3" AreaIndex="3" FieldName="VendedorFinal" Name="fieldVendedorFinal3" Options-ShowInFilter="True">
                              </dx:PivotGridField>
                              ...
                              <dx:PivotGridField ID="fieldVendedorAsignado2" Area="RowArea" AreaIndex="0" FieldName="VendedorAsignado" Name="fieldVendedorAsignado2" Options-ShowInFilter="True">
                              </dx:PivotGridField> 
                              
                              <dx:PivotGridField ID="fieldCliente" Area="RowArea" AreaIndex="0" FieldName="Cliente" Name="fieldCliente" Options-ShowInFilter="True">
                              </dx:PivotGridField> 
                              ...
                              <dx:PivotGridField ID="fieldTICKET" Area="DataArea" AreaIndex="1" FieldName="TICKET" Name="fieldTICKET" Options-ShowInFilter="True">
                              </dx:PivotGridField>
                              <dx:PivotGridField ID="fieldArticulos" Area="DataArea" AreaIndex="2" FieldName="#Articulos" Name="fieldArticulos" Options-ShowInFilter="True">
                              </dx:PivotGridField>
                          </Fields>
                      </dx:ASPxPivotGrid>
