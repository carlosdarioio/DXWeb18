<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTest1.Master" AutoEventWireup="true" CodeBehind="VtaxTienda.aspx.cs" Inherits="DXWeb18.Rpt.Vta.VtaxTienda" %>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-header">
            ...
            <h3 class="card-title">Ventas x Tiendas FM</h3>
                  ...
                  <div class="form-group">   
                      ...
                      <dx:ASPxPivotGrid ID="PivotGridViewXX"  ClientInstanceName="PivotGridViewXX"  runat="server"
                          ...
                          <Fields>
                              ...
                              <dx:PivotGridField ID="fieldMonth"  AreaIndex="1"
                              ...
                              <dx:PivotGridField ID="fieldSucursal" AreaIndex="0" Area="RowArea" FieldName="Sucursal" Name="fieldSucursal"
                               ...
                               <dx:PivotGridField ID="fieldTipoAlmacen" AreaIndex="1" Area="RowArea" FieldName="TipoAlmacen" Name="fieldTipoAlmacen" Options-ShowInFilter="True">
