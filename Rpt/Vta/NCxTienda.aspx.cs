...
{
    public partial class NCxTienda : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                try
                {
                    string sql = "EXEC	[AS400Sync].[dbo].[CFNCxTdaxDate]		@Sucursal = N'{0}',		@Desde = '{1}',		@Hasta = '{2}'";
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            ASPxPivotGridExporter1.ExportXlsToResponse("NCXTienda.xls", new XlsExportOptionsEx() { ExportType = ExportType.WYSIWYG });
            //---------------------------------
