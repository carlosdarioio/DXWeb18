<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTest1.Master" AutoEventWireup="true" CodeBehind="VtaXRado.aspx.cs" Inherits="DXWeb18.Rpt.Vta.VtaXRado" %>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-header">
            ...
            <h3 class="card-title">Ventas x Rado</h3>
                  ...
                  <div class="form-group">   
                      ...
                      <dx:ASPxPivotGrid ID="PivotGridViewXX"  ClientInstanceName="PivotGridViewXX"  runat="server"
                          ...
                          <Fields>
                              ...
                              <dx:PivotGridField ID="fieldCON"  AreaIndex="1" FieldName="CON" Name="fieldCON" Options-ShowInFilter="True">

                              </dx:PivotGridField>

                             

                              <dx:PivotGridField ID="fieldVendedorFinal" AreaIndex="2" FieldName="VendedorFinal" Name="fieldVendedorFinal" Options-ShowInFilter="True"
                              ...
                              <dx:PivotGridField ID="fieldMonth"  AreaIndex="3"
                              ...
                              <dx:PivotGridField ID="fieldTipoAlmacen" AreaIndex="4" FieldName="TipoAlmacen" Name="fieldTipoAlmacen" Options-ShowInFilter="True">

                              </dx:PivotGridField>

 

                             <dx:PivotGridField ID="fieldTipoArt" AreaIndex="4" FieldName="ItemCode" Name="fieldTipoArt" Options-ShowInFilter="True">

                              </dx:PivotGridField>

 

                              <dx:PivotGridField ID="fieldCountArticulos"  AreaIndex="5" FieldName="#Articulos" Name="fieldCountArticulos" Options-ShowInFilter="True">
                              ...
                              <dx:PivotGridField ID="fieldRado" AreaIndex="0" Area="RowArea" FieldName="Rado" Name="fieldRado"
