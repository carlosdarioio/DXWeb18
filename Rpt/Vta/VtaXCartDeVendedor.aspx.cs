...
{
    public partial class VtaXCartDeVendedor : System.Web.UI.Page
    {
        ...
        ", user));
            ...
            if (IsPostBack)
            {
                try
                {
                    string sql = "EXEC	[AS400Sync].[dbo].[CFRepVentaMensualXCarteraVendedor]		@DESDE = '{1}',		@HASTA = '{2}',		@SlpName = N'{0}'";
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            ASPxPivotGridExporter1.ExportXlsToResponse("RepVentaMensualXCarteraVendedor.xls", new XlsExportOptionsEx() { ExportType = ExportType.WYSIWYG });
            //---------------------------------
