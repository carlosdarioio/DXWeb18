<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTest1.Master" AutoEventWireup="true" CodeBehind="TckProm.aspx.cs" Inherits="DXWeb18.Rpt.Vta.TckProm" %>
                  ...
                  <div class="form-group">    
                      ...
                      <dx:ASPxPivotGrid ID="PivotGridViewXX"  ClientInstanceName="PivotGridViewXX"  runat="server"
                          ...
                          <Fields>
                              ...
                              <dx:PivotGridField ID="fieldTicket" Area="DataArea" AreaIndex="0"
                                    Caption="Ticket" 
                                   FieldName="Ticket" Name="fieldTicket">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldH" Area="DataArea" AreaIndex="1"
                                    Caption="H" FieldName="H" Name="fieldH">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldM" Area="DataArea" AreaIndex="2"
                                    Caption="M" FieldName="M" Name="fieldM">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldN" Area="DataArea" AreaIndex="3"
                                    Caption="N" FieldName="N" Name="fieldN">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldConversion" Area="DataArea" AreaIndex="4"
                                    Caption="%Conversion" FieldName="%Conversion" Name="fieldConversion">
                              </dx:PivotGridField>

                              <dx:PivotGridField ID="fieldTicketPromedio" Area="DataArea" AreaIndex="5"
                              ...
                              <dx:PivotGridField ID="fieldVentaDia" Area="DataArea" AreaIndex="5"
                                    Caption="VentaDia" FieldName="VentaDia" Name="fieldVentaDia">
                              </dx:PivotGridField>
